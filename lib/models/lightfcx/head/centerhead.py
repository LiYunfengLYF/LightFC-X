...
@MODEL_REGISTRY.register()
class Center_Head_with_SE(center_head):
    """
    Improve Center Head
        adding a SE between stage1 and stage2
    """

    def __init__(self, inplanes=64, channel=96, feat_sz=20, stride=16, reduction=4):
        super().__init__()
        ...
        self.conv5_ctr = nn.Conv2d(channel // 8, 1, kernel_size=1)
        self.se_ctr = SE(channel, reduction=reduction)
